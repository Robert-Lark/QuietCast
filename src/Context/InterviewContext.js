...
// export const InterviewInfo = createContext()
...
//     return (
//         <InterviewContext.Provider value={initialState}>
//             {children}
...
export const InterviewInfoProvider = (props) => {
const [interviewInfo, setInterviewInfo] = useState(interviewInformation)
    return (
<InterviewContext.Provider value={interviewInfo}>
{props.children}
</InterviewContext.Provider>
    );
}